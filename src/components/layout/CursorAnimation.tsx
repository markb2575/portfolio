  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      particles.current.forEach((p) => {
        const nX =
          noise3D(p.homeX * 0.01, p.homeY * 0.01, time) * noiseStrength;
        const nY =
          noise3D(p.homeX * 0.01 + 500, p.homeY * 0.01 + 500, time) *
          noiseStrength;

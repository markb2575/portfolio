...
export default function MobileMenu({ setMenuOpened }: MobileMenuProps) {
    ...
    return (
        <>
            <div className="z-50 backdrop-blur-md w-screen h-screen fixed left-0 top-0 m-0 p-0 flex flex-col items-center justify-center" onClick={() => setMenuOpened(false)}>

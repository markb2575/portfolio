            ...
            <div id="experience-section" ref={experienceRef} className='fade-in'>
                ...
                <div className="gap-4 mb-6">
                    {data?.experience.map((experience, index) => (
                        <Card key={index} className="h-full w-full relative opacity-60">
            ...
            <div id="education-section" ref={educationRef} className='fade-in'>
                ...
                <div className="gap-4 mb-6">
                    {data?.education.map((item, index) => (
                        <Card key={index} className="h-full w-full opacity-60">
                            <CardHeader className='justify-between w-full flex flex-row pb-4'>
            ...
            <div id="projects-section">
                ...
                <div className='flex flex-wrap gap-4'>
                    {data?.projects.map((project, index) => (
                        <Card key={index} ref={projectRefs.current[index]} className="flex flex-col md:w-72 flex-grow h-72 w-full fade-in opacity-60">
                            <CardHeader>
